...
<html>
    ...
    <body style="line-height: 0;">
        ...
        <div>
        <center>
        <body><h1 style="margin-bottom: 30px;">ตารางสอน</h1>
        </body>
        </center>

        <div class="input-group mb-3">
            <div class="input-group-prepend">
                <span class="input-group-text" id="inputGroup-sizing-sm" style="margin-left: 50px;"> รหัสวิชา </span>
            </div>
        <input type="text" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm">
            <select name="dayType1" id="" class="form-control" >
            ...
            <select name="timeType1" id="" class="form-control" >
            ...
            </select><select name="dayType1" id="" class="form-control" >
